...
COMPILE_FLAGS="$VK_HEADER_FLAGS -std=c++20 -Wfatal-errors autogen/*.cpp src/*.cpp -I autogen -I src -I external/json/single_include -I external/PicoSHA2 -I external/CppServer/include -I external/Vulkan-Headers/include -I external/CppServer/modules/asio/asio/include -Iexternal/CppServer/modules/CppCommon/include -I external/CppServer/modules/CppCommon/modules/fmt/include -L external/CppServer/bin -lcppserver"
