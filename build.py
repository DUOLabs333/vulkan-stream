...
SRC_FILES=["autogen/*","src/*","external/shm_open_anon/shm_open_anon.c","simdjson/src/simdjson.cpp"]
INCLUDE_PATHS=["autogen","src", "external/shm_open_anon", "external/Vulkan-Headers/include","external/asio/asio/include","external/boost","external/lz4/lib","external/komihash","external/Turbo-Base64","simdjson/include","simdjson/src"]
