...
SRC_FILES=["autogen/*","src/*","external/shm_open_anon/shm_open_anon.c","simdjson/src/simdjson.cpp","yyjson/src/yyjson.c"]
INCLUDE_PATHS=["autogen","src", "external/shm_open_anon", "external/Vulkan-Headers/include","external/asio/asio/include","external/boost","external/lz4/lib","external/komihash","external/simdjson/include","external/simdjson/src","external/Turbo-Base64","cpp-yyjson/include","nameof/include","fmt/include","yyjson/src"]
...
STATIC_LIBS=["external/lz4/lib/liblz4.a","external/Turbo-Base64/libtb64.a","fmt/build/libfmt.a"]
