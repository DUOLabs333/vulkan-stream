The only setup that is supported is with a MacOS computer as the server and a Linux computer as the client (though other setups shouldn't be too hard to adjust the program for)

On MacOS, the server must have MoltenVK >= 1.3.0, and vulkan-loader >= 1.3.275
